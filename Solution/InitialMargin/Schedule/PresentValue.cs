...
{
    /// <summary>Represents a present value. This class cannot be derived.</summary>
    public sealed class PresentValue : DataValue
    {
        ...
        /// <returns>A new instance of <see cref="T:InitialMargin.Schedule.PresentValue"/> initialized with the specified parameters.</returns>
